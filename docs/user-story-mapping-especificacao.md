> Declaração apenas das histórias de usuário MUST.
...
|                                   | US17                  | Eu, como cliente, quero selecionar as especificações do produto para filtrar as opções que atendem às minhas necessidades e preferências.                                              | R016 |
